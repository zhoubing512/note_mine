export {
    optionTest,
    optionMap,
    optionBar_newtv_user,
    option_bar_tv_user,
    option_pie_watching_time,
    option_pie_family_num,
    option_pie_family_stb_num,
    option_bar_bottom_left,
    option_bar_bottom_mid,
    option_bar_bottom_right
  }
//准备数据和配置项
var optionTest = {
    title: {
...
//新增
    ...
    var data_hottvb = [1619, 913, 810, 744, 653, 637, 470, 373, 340, 248];
    ...
    var data_hot_pd = [101565.5, 90331.53, 84355.62, 67667.98, 63608.61, 59022.68, 54876.12, 47373.32, 35152.98, 33057.68];
    var titlename = ['CCTV-1', '四川影视文艺-高清', 'CCTV-6', 'CCTV-13', 'CCTV-8', 'CCTV-3', '四川经济', 'CCTV-4', '湖南卫视', '四川公共'];
//     var myColor = ['#1089E7', '#F57474', '#56D0E3', '#1089E7', '#F57474', '#56D0E3', '#F8B448', '#8B78F6', '#F8B448', '#8B78F6'];
    var option_bar_bottom_mid = {
...
// })();
    ...
    var data_hot_movie = [14463.94,7606.5,5416.69,5270.42,5168.04,4758.86,3902.51,3544.89,3519.52,3063.31];
    var titlename = ['庆余年','小马宝莉','小马宝莉友谊的魔力 合集','三生三世枕上书','汪汪队立大功','哪吒之魔童降世','海绵宝宝合集','一剑横空','海绵宝宝（01-104）'];
//     var myColor = ['#1089E7', '#F57474', '#56D0E3', '#1089E7', '#F57474', '#56D0E3', '#F8B448', '#8B78F6', '#F8B448', '#8B78F6'];
    var option_bar_bottom_right = {
